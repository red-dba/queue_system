USE [TX]
GO
/****** Object:  StoredProcedure [dbo].[sp_add_repertoire_sur_reseau_sched_update_statut]    Script Date: 24/06/2023 15:29:39 ******/
SET ANSI_NULLS ON
GO
...
-- Creation : 22/06/2017
-- ============================================= =============================================
ALTER PROCEDURE [dbo].[sp_add_repertoire_sur_reseau_sched_update_statut] 
	 @id_demande int
AS
BEGIN
	SET NOCOUNT ON;
	...
	UPDATE [TX].[dbo].t_creation_repertoire_sur_reseau_sched
